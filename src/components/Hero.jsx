...
// Importar los estilos base de Swiper (Asegúrate de tener instalada la librería: npm install swiper)
import 'swiper/css';
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      >
            ...
            <div className={`${slide.bgColor} text-white pt-16 pb-32 px-4`}>
              <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div className="md:w-5/12 z-10 text-center md:text-left">
                  <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-6 uppercase tracking-wider">
                    {slide.title}
                  </h1>
                  ...
                  <button className="bg-[#0095ff] hover:bg-[#007acc] text-white px-10 py-4 rounded-xl font-bold text-sm tracking-widest flex items-center gap-2 mx-auto md:mx-0 transition-all shadow-lg active:scale-95">
                    {slide.buttonText}
        ...
        {/* Botones de Navegación y Paginación (Personalizados para evitar errores de CSS) */}
        <div className="absolute inset-0 pointer-events-none z-20">
           <div className="max-w-[90%] mx-auto h-full relative flex items-center justify-between px-4">
...
const ServiceCard = ({ icon, title, desc }) => (
  <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hover:-translate-y-2 transition-transform duration-300">
    <div className="bg-gray-100 w-12 h-12 rounded-lg flex items-center justify-center mb-4 text-gray-600">
      {icon}
    </div>
