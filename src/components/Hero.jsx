  ...
  const slides = [
    {
      ...
      link: "/cotizar",
      image: Asesoramiento, 
      bgColor: "bg-sf-dark" // Utiliza tu color configurado
    },
    {
            ...
            <div className={`relative h-full w-full ${slide.bgColor} flex items-center`}>
              ...
              <div className="max-w-7xl mx-auto px-6 relative z-10 w-full text-center md:text-left">
                <div className="max-w-2xl text-white mx-auto md:mx-0">
                  {/* Título optimizado con Merriweather */}
                  <h1 className="font-merriweather text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 md:mb-6 drop-shadow-lg">
                    {slide.title}
                  </h1>
                  {/* Descripción optimizada con Lato */}
                  <p className="font-lato text-sm md:text-lg mb-8 opacity-95 max-w-lg mx-auto md:mx-0">
                    {slide.description}
                  </p>
